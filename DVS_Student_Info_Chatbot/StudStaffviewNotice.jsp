...
<table width="872" border="0" align="center">
  ...
  rst=stmt.executeQuery("select * from staffnotice ");
  while(rst.next()){
  ...
  <tr bgcolor="#003399">
    ...
    <td><span class="style3 style1">
      <input name="e3" type="text" value="<%= rst.getString(4) %>" size="30" />
    </span></td>
    <td><span class="style3 style1"><input name="e4" type="text" value="<%= rst.getString(5) %>" size="10"/>
    </span></td>
